...
public:
	...
	virtual std::vector<VertexType>& Prim() = 0;
	virtual std::vector<Edge> Kruskal() = 0;
	virtual void Dijkstra(const VertexType& startVex, std::vector<int>& path, std::vector<EdgeType>& shortPathTable) = 0;
	virtual void Dijkstra(int startInd, std::vector<int>& path, std::vector<EdgeType>& shortPathTable) = 0;
	virtual void Floyd(std::vector<std::vector<int>>& path, std::vector<std::vector<EdgeType>>& shortPathTable) = 0;
